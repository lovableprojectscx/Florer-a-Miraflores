      ...
      <div className="px-6 md:px-10 lg:px-16 py-16 grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 font-body font-light text-sm text-muted-foreground">
            {["Ramos", "Box Florales", "Arreglos", "Coronas", "Ocasiones", "Delivery"].map((l) => (
              <li key={l}>
                <a href="/#catalogo" className="hover:text-foreground transition-colors">{l}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 font-body font-light text-sm text-muted-foreground">
            ...
            <li>
              <a href={`https://wa.me/${whatsapp.replace(/\D/g, "")}`} target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                {whatsapp}
              </a>
            </li>
            <li>
              <a href={`mailto:${correo}`} className="hover:text-foreground transition-colors">{correo}</a>
            </li>
            <li>{horario}</li>
          </ul>
          ...
          <div className="mt-6 flex gap-4">
            <a href={instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-foreground/60 hover:text-foreground transition-colors">
              <Instagram className="h-5 w-5" strokeWidth={1.25} />
            </a>
            {tiktok && (
              <a href={tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-foreground/60 hover:text-foreground transition-colors">
                <TikTokIcon />
              </a>
            )}
            {facebook && (
              <a href={facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-foreground/60 hover:text-foreground transition-colors">
